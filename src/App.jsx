...
const VOCAB_CATEGORIES_4 = [
  {
    ...
    words: [
      { en:"airport",     kanji:"空港",            kana:"くうこう",         hint:"Yuta loves flying — he often goes to the _____ to watch planes.",  tiles:["Yuta","loves","flying","—","he","often","goes","to","the","airport","to","watch","planes","."],  answer:"Yuta loves flying — he often goes to the airport to watch planes ." },
      { en:"museum",      kanji:"博物館",           kana:"はくぶつかん",     hint:"Yumi visited a _____ because she likes learning about history.",   tiles:["Yumi","visited","a","museum","because","she","likes","learning","about","history","."],          answer:"Yumi visited a museum because she likes learning about history ." },
      { en:"castle",      kanji:"城",               kana:"しろ",             hint:"We visited a beautiful _____ in Kyoto last weekend.",              tiles:["We","visited","a","beautiful","castle","in","Kyoto","last","weekend","."],                       answer:"We visited a beautiful castle in Kyoto last weekend ." },
      { en:"stadium",     kanji:"スタジアム",       kana:"スタジアム",       hint:"The man is talking at a sports _____.",                           tiles:["The","man","is","talking","at","a","sports","stadium","."],                                      answer:"The man is talking at a sports stadium ." },
      { en:"supermarket", kanji:"スーパー",         kana:"スーパー",         hint:"My dad buys vegetables at the _____ every Saturday.",             tiles:["My","dad","buys","vegetables","at","the","supermarket","every","Saturday","."],                  answer:"My dad buys vegetables at the supermarket every Saturday ." },
      { en:"café",        kanji:"カフェ",           kana:"カフェ",           hint:"Tim and his friend stayed at the _____ for two hours.",           tiles:["Tim","and","his","friend","stayed","at","the","café","for","two","hours","."],                   answer:"Tim and his friend stayed at the café for two hours ." },
      { en:"mall",        kanji:"ショッピングモール",kana:"ショッピングモール",hint:"Let's go to another store in the _____.",                        tiles:["Let's","go","to","another","store","in","the","mall","."],                                      answer:"Let's go to another store in the mall ." },
      { en:"restaurant",  kanji:"レストラン",       kana:"レストラン",       hint:"We had dinner at the new Italian _____ last night.",              tiles:["We","had","dinner","at","the","new","Italian","restaurant","last","night","."],                  answer:"We had dinner at the new Italian restaurant last night ." },
      { en:"bookstore",   kanji:"本屋",             kana:"ほんや",           hint:"There is a new _____ near my house with many kinds of books.",    tiles:["There","is","a","new","bookstore","near","my","house","with","many","kinds","of","books","."],   answer:"There is a new bookstore near my house with many kinds of books ." },
      { en:"gym",         kanji:"体育館・ジム",     kana:"たいいくかん",     hint:"My brother goes to the _____ twice a week to exercise.",          tiles:["My","brother","goes","to","the","gym","twice","a","week","to","exercise","."],                  answer:"My brother goes to the gym twice a week to exercise ." },
    ],
  },
  {
    ...
    words: [
      { en:"caught",  kanji:"かかった（病気）",   kana:"かかった",       hint:"Last week, Brian _____ a cold and stayed in bed for two days.",      tiles:["Last","week","Brian","caught","a","cold","and","stayed","in","bed","for","two","days","."],      answer:"Last week Brian caught a cold and stayed in bed for two days ." },
      { en:"forgot",  kanji:"忘れた",             kana:"わすれた",       hint:"I _____ my umbrella and got very wet in the rain.",                  tiles:["I","forgot","my","umbrella","and","got","very","wet","in","the","rain","."],                    answer:"I forgot my umbrella and got very wet in the rain ." },
      { en:"bought",  kanji:"買った",             kana:"かった",         hint:"Akira _____ a magazine this morning and enjoyed reading it.",        tiles:["Akira","bought","a","magazine","this","morning","and","enjoyed","reading","it","."],             answer:"Akira bought a magazine this morning and enjoyed reading it ." },
      { en:"won",     kanji:"勝った",             kana:"かった",         hint:"Daniel _____ the art contest and was very excited.",                 tiles:["Daniel","won","the","art","contest","and","was","very","excited","."],                          answer:"Daniel won the art contest and was very excited ." },
      { en:"told",    kanji:"伝えた・言った",     kana:"つたえた",       hint:"When he _____ his parents the good news, they were very happy.",    tiles:["When","he","told","his","parents","the","good","news","they","were","very","happy","."],        answer:"When he told his parents the good news they were very happy ." },
      { en:"wore",    kanji:"着た",               kana:"きた",           hint:"She _____ her new dress to the party last weekend.",                 tiles:["She","wore","her","new","dress","to","the","party","last","weekend","."],                       answer:"She wore her new dress to the party last weekend ." },
      { en:"left",    kanji:"出発した・帰った",   kana:"かえった",       hint:"Henry _____ school early yesterday because he was sick.",            tiles:["Henry","left","school","early","yesterday","because","he","was","sick","."],                    answer:"Henry left school early yesterday because he was sick ." },
      { en:"taught",  kanji:"教えた",             kana:"おしえた",       hint:"John _____ Ken how to speak English while they practiced soccer.",  tiles:["John","taught","Ken","how","to","speak","English","while","they","practiced","soccer","."],    answer:"John taught Ken how to speak English while they practiced soccer ." },
      { en:"took",    kanji:"乗った・かかった",   kana:"とった",         hint:"My grandfather _____ a plane for the first time last year.",        tiles:["My","grandfather","took","a","plane","for","the","first","time","last","year","."],             answer:"My grandfather took a plane for the first time last year ." },
      { en:"drove",   kanji:"運転した",           kana:"うんてんした",   hint:"On weekends, Ken's host family _____ to the beach or the mountains.", tiles:["On","weekends","Ken's","host","family","drove","to","the","beach","or","the","mountains","."],  answer:"On weekends Ken's host family drove to the beach or the mountains ." },
    ],
  },
  {
    ...
    words: [
      { en:"excited",      kanji:"わくわくした",  kana:"わくわくした",   hint:"Daniel was _____ to begin taking art lessons after he won.",       tiles:["Daniel","was","excited","to","begin","taking","art","lessons","after","he","won","."],         answer:"Daniel was excited to begin taking art lessons after he won ." },
      { en:"nervous",      kanji:"緊張した",      kana:"きんちょうした", hint:"Many people took part in the contest, so Daniel was _____.",       tiles:["Many","people","took","part","in","the","contest","so","Daniel","was","nervous","."],          answer:"Many people took part in the contest so Daniel was nervous ." },
      { en:"surprised",    kanji:"驚いた",        kana:"おどろいた",     hint:"When he told his parents, they were _____ but very happy.",        tiles:["When","he","told","his","parents","they","were","surprised","but","very","happy","."],         answer:"When he told his parents they were surprised but very happy ." },
      { en:"tired",        kanji:"疲れた",        kana:"つかれた",       hint:"Jack is _____ today — he should go home and rest.",               tiles:["Jack","is","tired","today","—","he","should","go","home","and","rest","."],                    answer:"Jack is tired today — he should go home and rest ." },
      { en:"wonderful",    kanji:"すばらしい",    kana:"すばらしい",     hint:"I got a new job at the library — that's _____!",                  tiles:["I","got","a","new","job","at","the","library","—","that's","wonderful","!"],                   answer:"I got a new job at the library — that's wonderful !" },
      { en:"useful",       kanji:"役に立つ",      kana:"やくにたつ",     hint:"This website is very _____ for finding sports information.",      tiles:["This","website","is","very","useful","for","finding","sports","information","."],              answer:"This website is very useful for finding sports information ." },
      { en:"heavy",        kanji:"重い",          kana:"おもい",         hint:"Takeru's bag has many books — it is very _____.",                 tiles:["Takeru's","bag","has","many","books","—","it","is","very","heavy","."],                        answer:"Takeru's bag has many books — it is very heavy ." },
      { en:"difficult",    kanji:"難しい",        kana:"むずかしい",     hint:"At first, Ken couldn't speak English — it was very _____.",       tiles:["At","first","Ken","couldn't","speak","English","—","it","was","very","difficult","."],         answer:"At first Ken couldn't speak English — it was very difficult ." },
      { en:"professional", kanji:"プロの",        kana:"プロの",         hint:"Kentaro wants to be a _____ baseball player in the future.",      tiles:["Kentaro","wants","to","be","a","professional","baseball","player","in","the","future","."],    answer:"Kentaro wants to be a professional baseball player in the future ." },
      { en:"delicious",    kanji:"おいしい",      kana:"おいしい",       hint:"We went to Spain and ate seafood — it was _____!",                tiles:["We","went","to","Spain","and","ate","seafood","—","it","was","delicious","!"],                 answer:"We went to Spain and ate seafood — it was delicious !" },
    ],
  },
  {
    ...
    words: [
      { en:"understand", kanji:"理解する",    kana:"りかいする",     hint:"She couldn't _____ her homework, so Paul helped her.",             tiles:["She","couldn't","understand","her","homework","so","Paul","helped","her","."],                 answer:"She couldn't understand her homework so Paul helped her ." },
      { en:"practice",   kanji:"練習する",    kana:"れんしゅうする", hint:"They _____ soccer together every day to improve.",                 tiles:["They","practiced","soccer","together","every","day","to","improve","."],                       answer:"They practiced soccer together every day to improve ." },
      { en:"join",       kanji:"参加する",    kana:"さんかする",     hint:"He wants to _____ a sports club next month.",                     tiles:["He","wants","to","join","a","sports","club","next","month","."],                               answer:"He wants to join a sports club next month ." },
      { en:"finish",     kanji:"終わる",      kana:"おわる",         hint:"When will you _____ cleaning your room?",                         tiles:["When","will","you","finish","cleaning","your","room","?"],                                     answer:"When will you finish cleaning your room ?" },
      { en:"bring",      kanji:"持ってくる",  kana:"もってくる",     hint:"Don't forget to _____ your umbrella — it might rain.",            tiles:["Don't","forget","to","bring","your","umbrella","—","it","might","rain","."],                   answer:"Don't forget to bring your umbrella — it might rain ." },
      { en:"visit",      kanji:"訪ねる",      kana:"たずねる",       hint:"Last July, she went to Rome and _____ some museums.",             tiles:["Last","July","she","went","to","Rome","and","visited","some","museums","."],                    answer:"Last July she went to Rome and visited some museums ." },
      { en:"arrive",     kanji:"到着する",    kana:"とうちゃくする", hint:"Olivia will _____ at the concert hall at 4:30.",                  tiles:["Olivia","will","arrive","at","the","concert","hall","at","4:30","."],                          answer:"Olivia will arrive at the concert hall at 4:30 ." },
      { en:"prepare",    kanji:"準備する",    kana:"じゅんびする",   hint:"I don't have enough time to _____ for the speech contest.",       tiles:["I","don't","have","enough","time","to","prepare","for","the","speech","contest","."],          answer:"I don't have enough time to prepare for the speech contest ." },
      { en:"decide",     kanji:"決める",      kana:"きめる",         hint:"She _____ to join a music school next month.",                    tiles:["She","decided","to","join","a","music","school","next","month","."],                           answer:"She decided to join a music school next month ." },
      { en:"win",        kanji:"勝つ",        kana:"かつ",           hint:"Ken played well and his team _____ the last game in Australia.", tiles:["Ken","played","well","and","his","team","won","the","last","game","in","Australia","."],       answer:"Ken played well and his team won the last game in Australia ." },
    ],
  },
  {
    ...
    words: [
      { en:"last weekend",      kanji:"先週末",      kana:"せんしゅうまつ",    hint:"I went snowboarding at Mt. Baker _____ — it was exciting.",   tiles:["I","went","snowboarding","at","Mt.","Baker","last","weekend","—","it","was","exciting","."],   answer:"I went snowboarding at Mt. Baker last weekend — it was exciting ." },
      { en:"next month",        kanji:"来月",        kana:"らいげつ",          hint:"Let's go skiing together _____.",                              tiles:["Let's","go","skiing","together","next","month","."],                                          answer:"Let's go skiing together next month ." },
      { en:"after school",      kanji:"放課後",      kana:"ほうかご",          hint:"I often go to the bookstore _____ to buy comic books.",        tiles:["I","often","go","to","the","bookstore","after","school","to","buy","comic","books","."],      answer:"I often go to the bookstore after school to buy comic books ." },
      { en:"before dinner",     kanji:"夕食の前",    kana:"ゆうしょくのまえ",  hint:"Alice loves to read _____ after she finishes her homework.",   tiles:["Alice","loves","to","read","before","dinner","after","she","finishes","her","homework","."],  answer:"Alice loves to read before dinner after she finishes her homework ." },
      { en:"every day",         kanji:"毎日",        kana:"まいにち",          hint:"They practiced soccer together _____ to improve.",             tiles:["They","practiced","soccer","together","every","day","to","improve","."],                      answer:"They practiced soccer together every day to improve ." },
      { en:"for the first time",kanji:"初めて",      kana:"はじめて",          hint:"My grandfather took a plane _____ last year.",                 tiles:["My","grandfather","took","a","plane","for","the","first","time","last","year","."],           answer:"My grandfather took a plane for the first time last year ." },
      { en:"at first",          kanji:"最初は",      kana:"さいしょは",        hint:"_____, Ken couldn't speak to his teammates in English.",       tiles:["At","first","Ken","couldn't","speak","to","his","teammates","in","English","."],             answer:"At first Ken couldn't speak to his teammates in English ." },
      { en:"in the end",        kanji:"最終的に",    kana:"さいしゅうてきに",  hint:"_____, Daniel won the contest and his parents were very happy.", tiles:["In","the","end","Daniel","won","the","contest","and","his","parents","were","very","happy","."], answer:"In the end Daniel won the contest and his parents were very happy ." },
      { en:"next week",         kanji:"来週",        kana:"らいしゅう",        hint:"My English speech contest is _____ — I have to prepare.",      tiles:["My","English","speech","contest","is","next","week","—","I","have","to","prepare","."],      answer:"My English speech contest is next week — I have to prepare ." },
      { en:"this weekend",      kanji:"今週末",      kana:"こんしゅうまつ",    hint:"My father will teach me how to ski _____.",                    tiles:["My","father","will","teach","me","how","to","ski","this","weekend","."],                     answer:"My father will teach me how to ski this weekend ." },
    ],
  },
  {
...
const VOCAB_CATEGORIES_5 = [
  ...
  },
  {
    ...
    words: [
      { en:"Monday",    kanji:"月曜日",kana:"げつようび",hint:"_____ is the first day of the school week.",tiles:["Monday","is","the","first","day","of","the","school","week","."],answer:"Monday is the first day of the school week ." },
      { en:"Tuesday",   kanji:"火曜日",kana:"かようび",  hint:"We have P.E. on _____.",                   tiles:["We","have","P.E.","on","Tuesday","."],                            answer:"We have P.E. on Tuesday ." },
      { en:"Wednesday", kanji:"水曜日",kana:"すいようび",hint:"_____ is the middle of the week.",          tiles:["Wednesday","is","the","middle","of","the","week","."],           answer:"Wednesday is the middle of the week ." },
      { en:"Thursday",  kanji:"木曜日",kana:"もくようび",hint:"I have English class on _____.",            tiles:["I","have","English","class","on","Thursday","."],                answer:"I have English class on Thursday ." },
      { en:"Friday",    kanji:"金曜日",kana:"きんようび",hint:"_____ is my favorite day of the week.",     tiles:["Friday","is","my","favorite","day","of","the","week","."],      answer:"Friday is my favorite day of the week ." },
      { en:"Saturday",  kanji:"土曜日",kana:"どようび",  hint:"I play soccer on _____.",                  tiles:["I","play","soccer","on","Saturday","."],                         answer:"I play soccer on Saturday ." },
      { en:"Sunday",    kanji:"日曜日",kana:"にちようび",hint:"We rest at home on _____.",                 tiles:["We","rest","at","home","on","Sunday","."],                       answer:"We rest at home on Sunday ." },
    ],
  },
  {
  ...
  },
  {
    ...
    color: "#f59e0b", shadow: "#d97706",
    words: [
      { en:"mother",      kanji:"お母さん",  kana:"おかあさん",  hint:"My _____ cooks dinner every night.",     tiles:["My","mother","cooks","dinner","every","night","."],     answer:"My mother cooks dinner every night ." },
      { en:"father",      kanji:"お父さん",  kana:"おとうさん",  hint:"My _____ goes to work by train.",        tiles:["My","father","goes","to","work","by","train","."],      answer:"My father goes to work by train ." },
      { en:"brother",     kanji:"お兄さん",  kana:"おにいさん",  hint:"My _____ plays soccer after school.",    tiles:["My","brother","plays","soccer","after","school","."],   answer:"My brother plays soccer after school ." },
      { en:"sister",      kanji:"お姉さん",  kana:"おねえさん",  hint:"My _____ likes reading books.",          tiles:["My","sister","likes","reading","books","."],            answer:"My sister likes reading books ." },
      { en:"grandfather", kanji:"おじいさん",kana:"おじいさん",  hint:"My _____ lives in the countryside.",     tiles:["My","grandfather","lives","in","the","countryside","."],answer:"My grandfather lives in the countryside ." },
      { en:"grandmother", kanji:"おばあさん",kana:"おばあさん",  hint:"My _____ makes delicious rice balls.",   tiles:["My","grandmother","makes","delicious","rice","balls","."],answer:"My grandmother makes delicious rice balls ." },
    ],
  },
  {
    ...
    words: [
      { en:"sunny",  kanji:"晴れ",  kana:"はれ",  hint:"It is _____ today — let's go to the park!",  tiles:["It","is","sunny","today","—","let's","go","to","the","park","!"],answer:"It is sunny today — let's go to the park !" },
      { en:"cloudy", kanji:"くもり",kana:"くもり",hint:"It is _____ and cold this morning.",          tiles:["It","is","cloudy","and","cold","this","morning","."],              answer:"It is cloudy and cold this morning ." },
      { en:"rainy",  kanji:"雨",   kana:"あめ",  hint:"It is _____ — I need my umbrella.",           tiles:["It","is","rainy","—","I","need","my","umbrella","."],              answer:"It is rainy — I need my umbrella ." },
      { en:"snowy",  kanji:"雪",   kana:"ゆき",  hint:"It is _____ in January.",                     tiles:["It","is","snowy","in","January","."],                              answer:"It is snowy in January ." },
      { en:"spring", kanji:"春",   kana:"はる",  hint:"Cherry blossoms bloom in _____.",             tiles:["Cherry","blossoms","bloom","in","spring","."],                    answer:"Cherry blossoms bloom in spring ." },
      { en:"summer", kanji:"夏",   kana:"なつ",  hint:"I love _____ because we go to the sea.",     tiles:["I","love","summer","because","we","go","to","the","sea","."],    answer:"I love summer because we go to the sea ." },
      { en:"autumn", kanji:"秋",   kana:"あき",  hint:"The leaves turn red and yellow in _____.",   tiles:["The","leaves","turn","red","and","yellow","in","autumn","."],     answer:"The leaves turn red and yellow in autumn ." },
      { en:"winter", kanji:"冬",   kana:"ふゆ",  hint:"I wear a coat in _____.",                     tiles:["I","wear","a","coat","in","winter","."],                           answer:"I wear a coat in winter ." },
    ],
  },
  {
    ...
    words: [
      { en:"red",    kanji:"赤",       kana:"あか",       hint:"I have a _____ pen in my pencil case.",     tiles:["I","have","a","red","pen","in","my","pencil","case","."],    answer:"I have a red pen in my pencil case ." },
      { en:"blue",   kanji:"青",       kana:"あお",       hint:"The sky is _____ today.",                   tiles:["The","sky","is","blue","today","."],                         answer:"The sky is blue today ." },
      { en:"green",  kanji:"緑",       kana:"みどり",     hint:"I like _____ because it is the color of nature.", tiles:["I","like","green","because","it","is","the","color","of","nature","."], answer:"I like green because it is the color of nature ." },
      { en:"yellow", kanji:"黄色",     kana:"きいろ",     hint:"I have a _____ notebook.",                  tiles:["I","have","a","yellow","notebook","."],                      answer:"I have a yellow notebook ." },
      { en:"white",  kanji:"白",       kana:"しろ",       hint:"My school shirt is _____.",                 tiles:["My","school","shirt","is","white","."],                      answer:"My school shirt is white ." },
      { en:"black",  kanji:"黒",       kana:"くろ",       hint:"My bag is _____.",                          tiles:["My","bag","is","black","."],                                 answer:"My bag is black ." },
      { en:"brown",  kanji:"茶色",     kana:"ちゃいろ",   hint:"My favorite color is _____.",               tiles:["My","favorite","color","is","brown","."],                    answer:"My favorite color is brown ." },
      { en:"pink",   kanji:"ピンク",   kana:"ピンク",     hint:"My sister's T-shirt is _____.",             tiles:["My","sister's","T-shirt","is","pink","."],                   answer:"My sister's T-shirt is pink ." },
      { en:"orange", kanji:"オレンジ", kana:"オレンジ",   hint:"I like _____ juice in the morning.",         tiles:["I","like","orange","juice","in","the","morning","."],        answer:"I like orange juice in the morning ." },
      { en:"purple", kanji:"むらさき", kana:"むらさき",   hint:"The flowers in the garden are _____.",       tiles:["The","flowers","in","the","garden","are","purple","."],      answer:"The flowers in the garden are purple ." },
    ],
  },
  {
    ...
    color: "#8b5cf6", shadow: "#6d28d9",
    words: [
      { en:"hot",        kanji:"暑い・熱い", kana:"あつい",       hint:"It is very _____ today — let's drink cold water.",  tiles:["It","is","very","hot","today","—","let's","drink","cold","water","."], answer:"It is very hot today — let's drink cold water ." },
      { en:"cold",       kanji:"寒い・冷たい",kana:"さむい",      hint:"It is _____ today, so I wear a coat.",              tiles:["It","is","cold","today","so","I","wear","a","coat","."],            answer:"It is cold today so I wear a coat ." },
      { en:"cool",       kanji:"涼しい",    kana:"すずしい",      hint:"It is cloudy and _____ today.",                    tiles:["It","is","cloudy","and","cool","today","."],                       answer:"It is cloudy and cool today ." },
      { en:"nice",       kanji:"すてきな",  kana:"すてきな",      hint:"Your new shoes are _____!",                        tiles:["Your","new","shoes","are","nice","!"],                             answer:"Your new shoes are nice !" },
      { en:"cute",       kanji:"かわいい",  kana:"かわいい",      hint:"My cat is very _____.",                            tiles:["My","cat","is","very","cute","."],                                 answer:"My cat is very cute ." },
      { en:"great",      kanji:"すばらしい",kana:"すばらしい",    hint:"This is my new computer — it's _____!",            tiles:["This","is","my","new","computer","—","it's","great","!"],         answer:"This is my new computer — it's great !" },
      { en:"delicious",  kanji:"おいしい",  kana:"おいしい",      hint:"The desserts at this restaurant are _____.",       tiles:["The","desserts","at","this","restaurant","are","delicious","."],  answer:"The desserts at this restaurant are delicious ." },
      { en:"tall",       kanji:"高い・背が高い",kana:"せがたかい", hint:"That tower is very _____.",                        tiles:["That","tower","is","very","tall","."],                             answer:"That tower is very tall ." },
      { en:"short",      kanji:"短い・背が低い",kana:"みじかい",   hint:"My ruler is _____.",                               tiles:["My","ruler","is","short","."],                                     answer:"My ruler is short ." },
      { en:"busy",       kanji:"忙しい",    kana:"いそがしい",    hint:"I am very _____ from Monday to Friday.",           tiles:["I","am","very","busy","from","Monday","to","Friday","."],         answer:"I am very busy from Monday to Friday ." },
    ],
  },
  {
    ...
    words: [
      { en:"draw",   kanji:"かく（絵を）",kana:"えをかく",   hint:"He _____ pictures of flowers in his free time.",    tiles:["He","draws","pictures","of","flowers","in","his","free","time","."], answer:"He draws pictures of flowers in his free time ." },
      { en:"wash",   kanji:"洗う",       kana:"あらう",     hint:"Mike is _____ his dog in the garden.",              tiles:["Mike","is","washing","his","dog","in","the","garden","."],          answer:"Mike is washing his dog in the garden ." },
      { en:"wear",   kanji:"着る",       kana:"きる",       hint:"Please _____ a coat today — it is very cold.",      tiles:["Please","wear","a","coat","today","—","it","is","very","cold","."], answer:"Please wear a coat today — it is very cold ." },
      { en:"catch",  kanji:"つかまえる", kana:"つかまえる", hint:"Sally's dog can stand and _____ a ball.",           tiles:["Sally's","dog","can","stand","and","catch","a","ball","."],         answer:"Sally's dog can stand and catch a ball ." },
      { en:"paint",  kanji:"ぬる・かく", kana:"えをかく",   hint:"Please _____ this wall.",                           tiles:["Please","paint","this","wall","."],                                 answer:"Please paint this wall ." },
      { en:"open",   kanji:"開ける",     kana:"あける",     hint:"Please _____ your book.",                           tiles:["Please","open","your","book","."],                                  answer:"Please open your book ." },
      { en:"close",  kanji:"閉める",     kana:"しめる",     hint:"Please _____ the windows — it is cold.",           tiles:["Please","close","the","windows","—","it","is","cold","."],         answer:"Please close the windows — it is cold ." },
      { en:"teach",  kanji:"教える",     kana:"おしえる",   hint:"What does Tom's father _____ at college?",          tiles:["What","does","Tom's","father","teach","at","college","?"],          answer:"What does Tom's father teach at college ?" },
      { en:"take",   kanji:"とる（写真）",kana:"しゃしんをとる",hint:"Julia often _____ pictures with her camera.", tiles:["Julia","often","takes","pictures","with","her","camera","."],       answer:"Julia often takes pictures with her camera ." },
      { en:"use",    kanji:"使う",       kana:"つかう",     hint:"I _____ a dictionary to find new words.",           tiles:["I","use","a","dictionary","to","find","new","words","."],           answer:"I use a dictionary to find new words ." },
    ],
  },
  {
    ...
    color: "#10b981", shadow: "#065f46",
    words: [
      { en:"soccer",     kanji:"サッカー",   kana:"サッカー",   hint:"I play _____ at the park every afternoon.",        tiles:["I","play","soccer","at","the","park","every","afternoon","."],     answer:"I play soccer at the park every afternoon ." },
      { en:"tennis",     kanji:"テニス",     kana:"テニス",     hint:"I like _____ — what about you?",                   tiles:["I","like","tennis","—","what","about","you","?"],                  answer:"I like tennis — what about you ?" },
      { en:"volleyball", kanji:"バレーボール",kana:"バレーボール",hint:"I like _____ because it is fun.",                 tiles:["I","like","volleyball","because","it","is","fun","."],             answer:"I like volleyball because it is fun ." },
      { en:"basketball", kanji:"バスケットボール",kana:"バスケットボール",hint:"I love _____ and I watch games on TV.", tiles:["I","love","basketball","and","I","watch","games","on","TV","."],   answer:"I love basketball and I watch games on TV ." },
      { en:"badminton",  kanji:"バドミントン",kana:"バドミントン",hint:"Let's play _____ at the park.",                  tiles:["Let's","play","badminton","at","the","park","."],                  answer:"Let's play badminton at the park ." },
      { en:"swimming",   kanji:"水泳",       kana:"すいえい",   hint:"Janet goes _____ every Sunday with her sister.",   tiles:["Janet","goes","swimming","every","Sunday","with","her","sister","."], answer:"Janet goes swimming every Sunday with her sister ." },
      { en:"skiing",     kanji:"スキー",     kana:"スキー",     hint:"Does your sister go _____ every year?",            tiles:["Does","your","sister","go","skiing","every","year","?"],           answer:"Does your sister go skiing every year ?" },
      { en:"jogging",    kanji:"ジョギング", kana:"ジョギング", hint:"Yuki's father often goes _____ in the morning.",   tiles:["Yuki's","father","often","goes","jogging","in","the","morning","."], answer:"Yuki's father often goes jogging in the morning ." },
      { en:"music",      kanji:"音楽",       kana:"おんがく",   hint:"Henry is a musician — he loves _____.",            tiles:["Henry","is","a","musician","—","he","loves","music","."],          answer:"Henry is a musician — he loves music ." },
      { en:"camera",     kanji:"カメラ",     kana:"カメラ",     hint:"Julia likes her _____ — she often takes pictures.", tiles:["Julia","likes","her","camera","—","she","often","takes","pictures","."], answer:"Julia likes her camera — she often takes pictures ." },
    ],
  },
  {
    ...
    color: "#0ea5e9", shadow: "#0369a1",
    words: [
      { en:"kitchen",     kanji:"台所",      kana:"だいどころ", hint:"My mom is cooking dinner in the _____.",           tiles:["My","mom","is","cooking","dinner","in","the","kitchen","."],       answer:"My mom is cooking dinner in the kitchen ." },
      { en:"living room", kanji:"リビング",  kana:"リビング",   hint:"Is Kim watching TV in the _____?",                 tiles:["Is","Kim","watching","TV","in","the","living","room","?"],          answer:"Is Kim watching TV in the living room ?" },
      { en:"bathroom",    kanji:"お風呂",    kana:"おふろ",     hint:"The cat is in the _____.",                         tiles:["The","cat","is","in","the","bathroom","."],                        answer:"The cat is in the bathroom ." },
      { en:"bedroom",     kanji:"寝室",      kana:"しんしつ",   hint:"My pajamas are on my bed in the _____.",           tiles:["My","pajamas","are","on","my","bed","in","the","bedroom","."],     answer:"My pajamas are on my bed in the bedroom ." },
      { en:"garden",      kanji:"庭",        kana:"にわ",       hint:"Mr. Hara has a big tree in his _____.",            tiles:["Mr.","Hara","has","a","big","tree","in","his","garden","."],       answer:"Mr. Hara has a big tree in his garden ." },
      { en:"floor",       kanji:"床",        kana:"ゆか",       hint:"Let's sit down on the _____ and watch TV.",        tiles:["Let's","sit","down","on","the","floor","and","watch","TV","."],    answer:"Let's sit down on the floor and watch TV ." },
      { en:"table",       kanji:"テーブル",  kana:"テーブル",   hint:"There is a history book on the _____.",            tiles:["There","is","a","history","book","on","the","table","."],          answer:"There is a history book on the table ." },
      { en:"chair",       kanji:"いす",      kana:"いす",       hint:"My red pen is under my _____.",                    tiles:["My","red","pen","is","under","my","chair","."],                    answer:"My red pen is under my chair ." },
      { en:"bed",         kanji:"ベッド",    kana:"ベッド",     hint:"Your pajamas are on your _____.",                  tiles:["Your","pajamas","are","on","your","bed","."],                      answer:"Your pajamas are on your bed ." },
      { en:"window",      kanji:"窓",        kana:"まど",       hint:"Please close the _____ — it is cold.",             tiles:["Please","close","the","window","—","it","is","cold","."],          answer:"Please close the window — it is cold ." },
    ],
  },
  {
    ...
    words: [
      { en:"dog",      kanji:"犬",     kana:"いぬ",       hint:"Mike is washing his _____ in the garden.",         tiles:["Mike","is","washing","his","dog","in","the","garden","."],         answer:"Mike is washing his dog in the garden ." },
      { en:"cat",      kanji:"猫",     kana:"ねこ",       hint:"I have a _____  — she is very cute.",               tiles:["I","have","a","cat","—","she","is","very","cute","."],             answer:"I have a cat — she is very cute ." },
      { en:"rabbit",   kanji:"うさぎ", kana:"うさぎ",     hint:"My sister has a pet _____.",                       tiles:["My","sister","has","a","pet","rabbit","."],                        answer:"My sister has a pet rabbit ." },
      { en:"bird",     kanji:"鳥",     kana:"とり",       hint:"A _____ is on Taro's head.",                        tiles:["A","bird","is","on","Taro's","head","."],                          answer:"A bird is on Taro's head ." },
      { en:"fish",     kanji:"魚",     kana:"さかな",     hint:"We can catch _____ in this river.",                 tiles:["We","can","catch","fish","in","this","river","."],                 answer:"We can catch fish in this river ." },
      { en:"elephant", kanji:"ぞう",   kana:"ぞう",       hint:"The _____ is the biggest animal at the zoo.",      tiles:["The","elephant","is","the","biggest","animal","at","the","zoo","."], answer:"The elephant is the biggest animal at the zoo ." },
      { en:"horse",    kanji:"馬",     kana:"うま",       hint:"Karen likes her _____.",                            tiles:["Karen","likes","her","horse","."],                                 answer:"Karen likes her horse ." },
      { en:"hamster",  kanji:"ハムスター",kana:"ハムスター",hint:"Karen likes her _____ — it lives in a cage.",    tiles:["Karen","likes","her","hamster","—","it","lives","in","a","cage","."], answer:"Karen likes her hamster — it lives in a cage ." },
      { en:"sheep",    kanji:"羊",     kana:"ひつじ",     hint:"There are many _____ on the farm.",                 tiles:["There","are","many","sheep","on","the","farm","."],                answer:"There are many sheep on the farm ." },
      { en:"butterfly",kanji:"ちょうちょ",kana:"ちょうちょ",hint:"A _____ flew into our garden.",                  tiles:["A","butterfly","flew","into","our","garden","."],                  answer:"A butterfly flew into our garden ." },
    ],
  },
  {
    ...
    color: "#6366f1", shadow: "#4338ca",
    words: [
      { en:"in",    kanji:"〜の中に・〜に", kana:"なかに",      hint:"The cat is _____ the kitchen.",                    tiles:["The","cat","is","in","the","kitchen","."],                         answer:"The cat is in the kitchen ." },
      { en:"on",    kanji:"〜の上に",       kana:"うえに",      hint:"The apples are _____ the box.",                    tiles:["The","apples","are","on","the","box","."],                         answer:"The apples are on the box ." },
      { en:"under", kanji:"〜の下に",       kana:"したに",      hint:"My red pen is _____ the chair.",                   tiles:["My","red","pen","is","under","the","chair","."],                   answer:"My red pen is under the chair ." },
      { en:"by",    kanji:"〜のそばに",     kana:"そばに",      hint:"Helen is sitting _____ the river.",                tiles:["Helen","is","sitting","by","the","river","."],                     answer:"Helen is sitting by the river ." },
      { en:"at",    kanji:"〜に（場所・時間）",kana:"に",        hint:"My mother works _____ the hospital.",              tiles:["My","mother","works","at","the","hospital","."],                   answer:"My mother works at the hospital ." },
      { en:"from",  kanji:"〜から・〜出身の",kana:"から",       hint:"My English teacher is _____ Australia.",           tiles:["My","English","teacher","is","from","Australia","."],              answer:"My English teacher is from Australia ." },
      { en:"to",    kanji:"〜へ・〜に",     kana:"へ",          hint:"I walk _____ school every morning.",               tiles:["I","walk","to","school","every","morning","."],                    answer:"I walk to school every morning ." },
      { en:"with",  kanji:"〜と一緒に",     kana:"いっしょに",  hint:"I play basketball _____ my brother.",              tiles:["I","play","basketball","with","my","brother","."],                 answer:"I play basketball with my brother ." },
      { en:"for",   kanji:"〜のために",     kana:"ために",      hint:"I am cooking breakfast _____ Hiroshi.",            tiles:["I","am","cooking","breakfast","for","Hiroshi","."],                answer:"I am cooking breakfast for Hiroshi ." },
      { en:"about", kanji:"〜について",     kana:"について",    hint:"What _____ you, Rachel — do you like tennis?",     tiles:["What","about","you","Rachel","—","do","you","like","tennis","?"], answer:"What about you Rachel — do you like tennis ?" },
    ],
  },
  {
...
/* ── Header ── */
.hdr       { background:linear-gradient(135deg,#ff6b9d,#ff9de2); padding:14px 28px; display:flex; align-items:center; gap:14px; box-shadow:0 3px 14px rgba(255,107,157,.28); flex-shrink:0; }
...
.hero-h     { font-family:'Nunito',sans-serif; font-weight:900; font-size:28px; color:#2d3748; margin-top:8px; }
...
.tinput  { width:100%; padding:14px 16px; border-radius:13px; border:2px solid #e2e8f0; font-family:'Inter',sans-serif; font-size:17px; color:#2d3748; outline:none; background:#fff; transition:border-color .15s; }
.tinput:focus { border-color:#ff9de2; }
.pselect { width:100%; padding:14px 16px; border-radius:13px; border:2px solid #e2e8f0; font-family:'Inter',sans-serif; font-size:17px; color:#2d3748; background:#fff; cursor:pointer; outline:none; }
...
.lpill.sel { border-color:#ff6b9d; background:#fff0f6; }
...
.btn-pink { background:#ff6b9d; box-shadow:0 4px 0 #cc4477; }
...
.avatar  { width:52px; height:52px; border-radius:50%; background:linear-gradient(135deg,#ff6b9d,#ff9de2); display:flex; align-items:center; justify-content:center; font-size:22px; font-weight:900; color:#fff; font-family:'Nunito',sans-serif; flex-shrink:0; }
.av-name { font-family:'Nunito',sans-serif; font-weight:900; font-size:22px; color:#2d3748; }
...
.wl-row { background:#f7fafc; border-radius:10px; padding:9px 12px; margin-bottom:6px; display:flex; align-items:center; gap:10px; border:1px solid #e8edf3; }
...
.plabel { display:inline-block; background:#f0f4f8; border-radius:20px; padding:4px 16px; font-size:12px; font-weight:700; color:#718096; letter-spacing:.5px; }
.ptitle { font-family:'Nunito',sans-serif; font-weight:900; font-size:22px; color:#2d3748; margin-top:6px; }

.wdisplay { text-align:center; padding:8px 0 14px; }

.ord-target { text-align:center; background:#f0f4f8; border-radius:14px; padding:20px 12px; margin-bottom:14px; }
.ord-num    { font-family:'Nunito',sans-serif; font-weight:900; font-size:52px; color:#2d3748; }
.ord-hint   { font-size:13px; color:#718096; margin-top:5px; }

.cbtn { width:100%; padding:14px 16px; border-radius:13px; border:2.5px solid #e2e8f0; background:#fff; font-family:'Nunito',sans-serif; font-weight:700; font-size:17px; color:#2d3748; cursor:pointer; margin-bottom:9px; text-align:left; display:flex; align-items:center; gap:10px; transition:all .12s; }
.cbtn:hover:not(:disabled) { border-color:#cbd5e0; background:#f7fafc; }
...
.sinput { width:100%; padding:15px 16px; border-radius:13px; border:2.5px solid #e2e8f0; font-family:'Nunito',sans-serif; font-weight:700; font-size:22px; color:#2d3748; outline:none; text-align:center; background:#f7fafc; transition:border-color .15s; }
.sinput:focus   { border-color:#ff9de2; background:#fff; }
...
.fbtn { width:100%; padding:14px; border-radius:13px; border:2.5px solid #e2e8f0; background:#fff; font-family:'Nunito',sans-serif; font-weight:800; font-size:17px; color:#2d3748; cursor:pointer; margin-bottom:9px; text-align:center; transition:all .12s; }
.fbtn:hover:not(:disabled) { border-color:#cbd5e0; background:#f7fafc; }
...
.tile-area { min-height:52px; background:#f0f4f8; border-radius:13px; padding:8px; display:flex; flex-wrap:wrap; gap:6px; margin-bottom:10px; border:2px dashed #cbd5e0; }
.tile-area.shk { animation:shake .4s ease; }
.tile { background:#fff; border:2px solid #e2e8f0; border-radius:9px; padding:8px 14px; font-family:'Nunito',sans-serif; font-weight:800; font-size:15px; color:#2d3748; cursor:pointer; transition:all .12s; user-select:none; }
.tile:hover:not(.used) { border-color:#a0aec0; transform:translateY(-1px); }
.tile.in-ans { border-color:#ff6b9d; background:#fff0f6; color:#c4175a; }
...
.sen-disp { background:#f0f4f8; border-radius:13px; padding:14px 16px; margin-bottom:10px; font-family:'Nunito',sans-serif; font-weight:700; font-size:18px; color:#2d3748; line-height:1.5; text-align:center; }
.blank    { color:#ff6b9d; font-style:italic; }
...
.rev-banner       { background:#fff0f6; border-radius:14px; padding:16px 18px; margin-bottom:16px; text-align:center; border:2px solid #ffcfe0; }
.rev-banner-title { font-family:'Nunito',sans-serif; font-weight:900; font-size:19px; color:#c4175a; }
.rev-banner-sub   { font-size:13px; color:#e05585; margin-top:4px; }

.slabel   { font-size:11px; font-weight:700; color:#a0aec0; letter-spacing:.5px; text-transform:uppercase; margin-bottom:10px; }
.cap-note { font-size:11px; color:#f59e0b; font-weight:600; margin-left:6px; }
`;
            ...
            <div className="sidebar">
              {screen === "dashboard" && (
                <>
                  ...
                  <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:15,color:"#ff6b9d",marginBottom:4}}>📖 Vocabulary</div>
                  {categories.map(cat => (
                  ...
                  {categories.map(cat => {
                    ...
                    return (
                      <button type="button" key={cat.id}
                        ...
                        style={{display:"flex",alignItems:"center",gap:8,width:"100%",background:activeCategory?.id===cat.id?"#fff0f6":"transparent",border:"none",cursor:"pointer",
                ...
                <>
                  ...
                  {activeCategory.words.map((w, i) => (
                    <div key={w.en} className="wl-row">
                      ...
                      <div style={{flex:1}}>
                        <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:700,fontSize:13,color:"#2d3748"}}>{w.en}</div>
          ...
          {["returning","new"].map(v => (
            <button type="button" key={v}
              style={{flex:1,padding:"12px",borderRadius:"12px",border:"2px solid",fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:15,cursor:"pointer",
                borderColor:view===v?"#ff6b9d":"#e2e8f0",background:view===v?"#fff0f6":"#fff",color:view===v?"#c4175a":"#718096"}}
              onClick={() => setView(v)}>
        ...
        <div className="fade">
          ...
          {EIKEN_LEVELS.map(lvl => (
            <div key={lvl.id} className={`lpill ${selectedLevel===lvl.id?"sel":""}`}
              ...
              <div>
                <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:16,color:selectedLevel===lvl.id?lvl.color:"#2d3748"}}>{lvl.label}</div>
...
function DashboardScreen({ profile, onVocab, categories, getCatProgress, onLevelChange }) {
  ...
  const levels    = [
    { id:"5", label:"Grade 5", sub:"えいけん5きゅう", color:"#ff6b9d" },
    ...
    <div className="fade">
      ...
      <div style={{marginBottom:20}}>
        ...
        {profile.level === "5" && done === categories.length && (
          <div style={{marginTop:10,padding:"10px 14px",background:"#fff0f6",borderRadius:"12px",border:"1px solid #ffcfe0",fontSize:13,color:"#c4175a",fontWeight:600}}>
      ...
      <div className="mod-grid">
        <button type="button" className="mod-card" onClick={onVocab}>
          <div className="mod-icon" style={{background:"#fff0f6"}}>📖</div>
          <div>
            <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:18,color:"#2d3748"}}>Vocabulary</div>
        ...
        <div key={w.en} className="wl-row" style={{background:"#fff",border:"1.5px solid #e8edf3",padding:"13px 16px",marginBottom:8,borderRadius:13}}>
          ...
          {w.isOrdinal ? (
            <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10}}>
              <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:17,color:"#2d3748"}}>{w.en}</div>
  ...
  if (allClear) {
    return (
      <div className="quiz-wrap fade" style={{textAlign:"center",paddingTop:48}}>
        ...
        <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:26,color:"#2d3748",marginTop:12}}>All cleared!</div>
        ...
        <div className="card">
          ...
          {missed.map(({word:w, scores:s}) => (
            <div key={w.en} className="rev-item">
              <div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,fontSize:16,color:"#2d3748"}}>
