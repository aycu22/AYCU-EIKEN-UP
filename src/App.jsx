...
const DIALOGUE_TESTS = {
  ...
  at_school: {
    ...
    practice2: [
      ...
      mkQ("Are you ready for the test, Ken?","👩","Yes! ( )","👦",
        ["Can I study a little more?","I like tests.","Tests are hard.","It's in my bag."],
        0,
        "ケンは「Yes!」と言っているよ。テストの準備ができている人は次に何を言う？\n「Can I study a little more?」→ もう少し勉強したいと言っているから正解！\n「Tests are hard.」→ かんそうを言っているだけだよ。",
        "ケン、テストの準備はできた？","うん！もう少し勉強してもいい？"),
      ...
      mkQ("Kenta, please don't talk during class.","👩","( ) I'll be quiet.","👦",
        ["I can talk loud.","I'm sorry, Ms. Sato.","The class is big.","I like talking."],
        1,
        "先生にちゅういされたよ。「I'll be quiet.（静かにします）」の前に何を言う？\n「I'm sorry, Ms. Sato.」→ あやまっているから正解！\n「I can talk loud.」→ 大きな声で話せるかどうかは関係ないよ。",
        "ケンタ、授業中に話さないで。","ごめんなさい、先生。静かにします。"),
      mkQ("Ms. Sato, can we play outside today?","👧","( ) Bring your jackets!","👩",
        ...
        "先生、今日は外で遊んでもいいですか。","もちろん。上着を持ってきてね！"),
      mkQ("Yuki, what are you doing at your desk?","👩","( ) It's for the school festival!","👧",
        ...
        "ユキ、机で何をしているの？学園祭のためだよ！","ポスターをかいているよ。"),
      mkQ("Where's my classmate, Ms. Sato?","👦","( ) He'll be back for lunch.","👩",
        ...
        "先生、ぼくのクラスメートはどこですか。お昼には戻ってくるよ。","保健室にいますよ。"),
    ],
    practice3: [
      mkQ("Aki, your notebook is not in your desk.","👩","( ) I used it yesterday.","👧",
        ...
        "アキ、ノートが机に入っていないよ。きのう使ったんだ。","かばんの中にあるよ。"),
      ...
      mkQ("When is the field trip, Ms. Sato? Let's pack our bags tomorrow!","👧","( )","👩",
        ...
        "先生、遠足はいつですか。あしたかばんを準備しよう！","今度の木曜日だよ。"),
      mkQ("Please put away your pencils, Riku. It's time for lunch.","👩","( )","👦",
        ["I like this pencil.","The pencil is sharp.","OK, Ms. Sato. I'm hungry!","It's a good pencil."],
        2,
        "先生がえんぴつをしまってねと言っているよ。もうお昼の時間！なんて答える？\n「OK, Ms. Sato. I'm hungry!」→ 「わかった！」は自然な答えだから正解！\n「I like this pencil.」と「The pencil is sharp.」→ 両方えんぴつのことを言っているよ。だまされないで！",
        "リク、えんぴつをしまってね。もうお昼の時間だよ。","わかりました、先生。おなかすいた！"),
      mkQ("Ms. Sato, can I borrow a pencil? But bring your own tomorrow.","👦","( )","👩",
        ...
        "先生、えんぴつを借りてもいいですか。でもあしたは自分のを持ってきてね。","もちろん。"),
      mkQ("You're working hard, Sora. What are you doing? It's for homework tomorrow.","👩","( )","👦",
        ...
        "ソラ、がんばっているね。何をしているの？あしたの宿題のためだよ。","レポートを書いているよ。"),
      mkQ("Ms. Sato, where's my friend Hana? She'll be back after music class.","👧","( )","👩",
        ...
        "先生、友達のハナはどこですか。音楽の授業のあとに戻ってくるよ。","音楽の授業に行っているよ。"),
    ],
    quiz: [
      mkQ("Ms. Sato, where's my library book?","👦","( )","👩",
        ["It's Tuesday.","Reading is fun.","It's in your bag.","I like books."],
        2, null,
        "先生、図書室の本はどこですか。","かばんの中にあるよ。"),
      mkQ("What do you want to draw, Mei?","👩","( )","👧",
        ["Drawing is fun.","After school.","A cat, please.","I drew a cat."],
        2, null,
        "メイ、何を描きたい？","ねこをお願いします。"),
      mkQ("When is the music concert, Ms. Sato? We need to practice singing!","👦","( )","👩",
        ["Music is fun.","It's next Monday.","She's at the concert.","I like singing."],
        1, null,
        "先生、音楽会はいつですか。歌の練習をしなきゃ！","今度の月曜日だよ。"),
      mkQ("Please line up quietly, Sota.","👩","( )","👦",
        ["The line is long.","I like lining up.","All right, Ms. Sato!","My legs are tired."],
        2, null,
        "ソウタ、静かに並んでね。","わかりました、先生！"),
      mkQ("Ms. Sato, can I use the computer?","👧","( ) Just for ten minutes, OK?","👩",
        ["Computers are useful.","Of course.","It's in the library.","I like computers."],
        1, null,
        "先生、コンピューターを使ってもいいですか。10分だけね。","もちろん。"),
      mkQ("Yuta, what are you doing? It's due this afternoon!","👩","( )","👦",
        ["I did my project.","I do projects every week.","I'm finishing my project.","Projects are hard."],
        2, null,
        "ユウタ、何をしているの？今日の午後までだよ！","プロジェクトを仕上げているよ。"),
      mkQ("Where's your classmate, Rio? She said she'll be back by two.","👩","( )","👦",
        ...
        "リオ、クラスメートはどこ？2時までに戻ると言っていたよ。","保健室に行ったよ。"),
    ],
  },
};
