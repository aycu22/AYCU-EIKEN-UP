...
const DIALOGUE_TOPICS = [
  ...
  { id:"responses", title:"RESPONSES", emoji:"🗨️", color:"#059669", shadow:"#065f46", level:"5" },
];
...
const DIALOGUE_TESTS = {
  ...
  at_school: {
    practice1: [
      ...
      mkQ("What time is math class?","👧","( )","👩",
        ["It's fun.","At nine o'clock.","I like math.","Yes, I do."],
        1,
        "「What time」はじかんをきく言葉だよ！\n「At nine o'clock.」→ じかんを答えているから正解！\n「It's fun.」→ かんそうを言っているよ。\n「I like math.」→ すきかどうかを答えているよ。",
        "算数の授業は何時ですか。","9時だよ。"),
      ...
      mkQ("What are you doing, Emily?","👩","( )","👧",
        ["I'm reading a book.","It's my book.","I read every day.","Books are fun."],
        0,
        "「What are you doing?」→「I'm ＋ 〜ing」で答えよう！\n「I'm reading a book.」→ 「I'm +〜ing」の形だから正解！\n「I read every day.」→ まいにちのことを言っているよ。今のことじゃないね。",
        "エミリー、何をしているの？","本を読んでいるよ。"),
      ...
      mkQ("What subject do we have next?","👧","( )","👦",
        ["It's science.","After lunch.","I like science.","Yes, we do."],
        0,
        "「What subject」は科目をきく言葉だよ！\n「It's science.」→ 科目を答えているから正解！\n「After lunch.」→ これは「いつ？」への答えだよ。\n「I like science.」→ すきかどうかを答えているよ。",
        "次は何の授業？","理科だよ。"),
    ],
    practice2: [
      ...
      mkQ("Lucy, what are you doing at your desk?","👩","( ) It's for the school festival!","👧",
        ["I like my desk.","The desk is big.","I'm drawing a poster.","I drew a poster yesterday."],
        2,
        "「It's for the school festival!」→ 学園祭のために何をしている？「I'm ＋〜ing」で答えよう！\n「I'm drawing a poster.」→ 「I'm +〜ing」の形だから正解！\n「I drew a poster yesterday.」→ 「drew」はきのうのこと。今やっていることじゃないよ。",
        "ルーシー、机で何をしているの？学園祭のためだよ！","ポスターをかいているよ。"),
    ...
    practice3: [
      ...
      mkQ("When is the field trip, Ms. Parker? Let's pack our bags tomorrow!","👧","( )","👩",
        ["It's fun.","It's next Thursday.","She's at school.","I like trips."],
        1,
        "「Let's pack our bags tomorrow!」→ 遠足はもうすぐ！いつ？\n「It's next Thursday.」→ 日にちを答えているから正解！\n「She's at school.」→ これは「どこ？」への答えだよ。",
        "パーカー先生、遠足はいつですか。あしたかばんを準備しよう！","今度の木曜日だよ。"),
      ...
      mkQ("You're working hard, Alex. What are you doing? It's for homework tomorrow.","👩","( )","👦",
        ["I was writing a report.","I write every night.","I'm writing a report.","Reports are interesting."],
        2,
        "「What are you doing?」→「I'm ＋〜ing」で答えよう！「It's for homework tomorrow.」→ 今やっていることだよ。\n「I'm writing a report.」→ 「I'm +〜ing」の形だから正解！\n「I was writing a report.」→「was」を使うとまえのことになるよ。今じゃないね！",
        "アレックス、がんばっているね。何をしているの？あしたの宿題のためだよ。","レポートを書いているよ。"),
    ...
    quiz: [
      ...
      mkQ("What do you want to draw, Amy?","👩","( )","👧",
        ["Drawing is fun.","After school.","A cat, please.","I drew a cat."],
        2, null,
        "エイミー、何を描きたい？","ねこをお願いします。"),
      mkQ("When is the music concert, Ms. Carter? We need to practice singing!","👦","( )","👩",
        ["Music is fun.","It's next Monday.","She's at the concert.","I like singing."],
        1, null,
        "カーター先生、音楽会はいつですか。歌の練習をしなきゃ！","今度の月曜日だよ。"),
      ...
      mkQ("Kevin, what are you doing? It's due this afternoon!","👩","( )","👦",
        ["I did my project.","I do projects every week.","I'm finishing my project.","Projects are hard."],
        2, null,
        "ケビン、何をしているの？今日の午後までだよ！","プロジェクトを仕上げているよ。"),
  ...
  responses: {
    practice1: [
      mkQ("I enjoy basketball.","👦","( ) I often play it on Sundays.","👧",
        ["No, I don't.","I do, too.","That's OK.","You're welcome."],
        1,
        "「I do, too.」→「わたしも！」という意味。すきなことに同意しているから正解！\n「No, I don't.」→ はんたいの意味になってしまうよ。\n「That's OK.」と「You're welcome.」→ お礼やあやまりへの返事だから、ここでは合わないよ。",
        "ぼくはバスケットボールが好きなんだ。","わたしも好きだよ！日曜日によくやるよ。"),
      mkQ("Jack, your blue jacket is nice.","👧","( ) Emily.","👦",
        ["Thanks,","Good job,","You're welcome,","They're interesting,"],
        0,
        "ほめられたら「Thanks,」＋名前で答えるよ。「Thanks, Emily.」で「ありがとう、エミリー」という意味になるから正解！\n「Good job,」→ これは相手をほめるときの言葉だよ。\n「You're welcome,」→ お礼を言われたときの返事だよ。",
        "ジャック、あなたの青いジャケットすてきね。","ありがとう、エミリー。"),
      mkQ("Let's go to that hamburger shop.","👨","( ) I'm hungry.","👩",
        ["Good idea.","See you.","That's all.","It's sunny today."],
        0,
        "さそわれたときに賛成するなら「Good idea.（いいね）」と答えるよ。「I'm hungry.」ともうまくつながるね。\n「See you.」→ わかれるときのあいさつだよ。\n「That's all.」→ 「これで終わり」という意味だよ。",
        "あのハンバーガー屋さんに行こうよ。","いいね。おなかすいたんだ。"),
      mkQ("Let's start today's English lesson. ( )","👩","OK, Ms. Peterson.","👦",
        ["See you tomorrow.","We're going to school.","Please open your book.","You can go home."],
        2,
        "授業を始めるとき、先生は次に何を言う？「Please open your book.（本を開いてください）」が自然だから正解！\n「See you tomorrow.」→ 授業の終わりに言う言葉だよ。\n「You can go home.」→ 帰るときに言う言葉だよ。",
        "今日の英語のじゅぎょうを始めましょう。本を開いてください。","わかりました、ピーターソン先生。"),
      mkQ("Please close the windows, Jack. ( )","👩","Yes, Ms. Carter.","👦",
        ["Good morning.","Here you are.","It's cold.","It's today."],
        2,
        "「まどをしめてね」の理由は何だろう？「It's cold.（寒いから）」が自然な理由だから正解！\n「Good morning.」→ あさのあいさつだよ。\n「Here you are.」→ ものをわたすときに言う言葉だよ。",
        "ジャック、まどをしめてください。寒いから。","わかりました、カーター先生。"),
      mkQ("Here's your notebook, Grace.","👦","( ) Sam.","👧",
        ["Thank you,","You're welcome,","Excuse me,","Nice to meet you,"],
        0,
        "ものをもらったら「Thank you,」＋名前でお礼を言うよ。\n「You're welcome,」→ お礼を言われたときに答える言葉だよ。ここでは合わないね。",
        "はい、ノートだよ、グレース。","ありがとう、サム。"),
      mkQ("It's very hot today.","👧","( ) Let's drink some water.","👦",
        ["It is.","I'm sorry.","Here you are.","Nice to meet you."],
        0,
        "「It is.」→「そうだね」と同意しているから正解！天気について話しているときの自然な返事だよ。\n「I'm sorry.」→ あやまるときの言葉だよ。",
        "今日はとても暑いね。","そうだね。水を飲もう。"),
    ],
    practice2: [
      mkQ("Do you want to play tennis with us, Mia?","👦","( ) I have piano practice today.","👧",
        ["Sure, let's go.","I'm sorry, I can't.","You're welcome.","Nice to meet you."],
        1,
        "ミアはピアノのれんしゅうがあるから、さそいをことわっているよ。「I'm sorry, I can't.（ごめんね、できないの）」が正解！\n「Sure, let's go.」→ これは「行こう！」というさんせいの返事だよ。",
        "アレックス、いっしょにテニスをしない？","ごめんね、できないの。今日はピアノのれんしゅうがあるんだ。"),
      mkQ("Can you help me with my bag, Ben? ( )","👧","Sure, Kate.","👦",
        ["It's very heavy.","It's a nice bag.","I like bags.","It's Monday."],
        0,
        "なぜ手伝ってほしいのかな？「It's very heavy.（すごく重いの）」が理由として自然だから正解！\n「It's a nice bag.」→ かばんの感想だから、理由にならないよ。",
        "ベン、かばんを持つの手伝ってくれる？すごく重いの。","いいよ、ケイト。"),
      mkQ("I got a new puppy yesterday!","👧","( ) What's its name?","👦",
        ["That's great!","I'm sorry.","See you later.","Here you are."],
        0,
        "うれしいニュースを聞いたときは「That's great!（すごいね！）」と答えるよ。\n「I'm sorry.」→ 悲しいことを聞いたときの言葉だよ。",
        "きのう、新しい子犬を飼ったんだ！","すごいね！名前は何？"),
      mkQ("It's three o'clock now. ( )","👨","Goodbye, Mr. Turner!","👧",
        ["Please sit down.","You can go home now.","Open your books.","Be quiet, please."],
        1,
        "3時になったよ。じゅぎょうがおわるとき、先生は何と言う？「You can go home now.（もう帰っていいですよ）」が自然だから正解！",
        "もう3時ですね。もう帰っていいですよ。","さようなら、ターナー先生！"),
      mkQ("I'm sorry I'm late, Ms. Wilson.","👦","( ) Please sit down.","👩",
        ["That's OK.","You're welcome.","Nice to meet you.","See you."],
        0,
        "あやまられたときは「That's OK.（だいじょうぶだよ）」と答えるよ。\n「You're welcome.」→ お礼を言われたときの言葉だから、ここでは合わないよ。",
        "遅れてすみません、ウィルソン先生。","だいじょうぶだよ。すわってね。"),
      mkQ("How much is this pen?","👧","( ) Here you are.","👨",
        ["It's 200 yen.","It's a good pen.","I like pens.","It's Tuesday."],
        0,
        "「How much」はねだんをきく言葉だよ。「It's 200 yen.（200円です）」が正解！\n「It's a good pen.」→ かんそうだから、ねだんの答えにならないよ。",
        "このペンはいくらですか。","200円です。はい、どうぞ。"),
      mkQ("I have to go home now, Leo.","👧","OK, Nina. ( )","👦",
        ["See you tomorrow.","Here you are.","Good job.","It's cold."],
        0,
        "わかれるときは「See you tomorrow.（またあした）」と言うよ。自然なあいさつだから正解！",
        "もう家に帰らなきゃ、レオ。","わかった、ニナ。またあした。"),
    ],
    practice3: [
      mkQ("Would you like some more cake, Amy?","👩","( ) I'm full.","👧",
        ["Yes, please.","No, thank you.","You're welcome.","Here you are."],
        1,
        "おなかがいっぱいだから、ことわる返事をしよう。「No, thank you.（いいえ、けっこうです）」が正解！\n「Yes, please.」→ ほしいときの返事だから、ここでは合わないよ。",
        "エイミー、ケーキをもう少しいかが？","いいえ、けっこうです。おなかがいっぱいなの。"),
      mkQ("You need a library card to borrow books. ( )","👩","OK, here's my card.","👦",
        ["Do you have one?","It's a nice book.","The library is big.","Books are heavy."],
        0,
        "図書カードについて話しているよ。次に何をきく？「Do you have one?（持っていますか）」が自然だから正解！",
        "本を借りるには図書カードが必要ですよ。持っていますか。","はい、これがカードです。"),
      mkQ("Can I use your eraser, Ben?","👧","( ) Here you are.","👦",
        ["Sure.","You're welcome.","I'm sorry.","Excuse me."],
        0,
        "「Can I~?」でお願いされたら「Sure.（いいよ）」と答えるよ。\n「You're welcome.」→ お礼を言われたときの返事だから、ここでは合わないよ。\n「I'm sorry.」→ 理由がないのに、あやまる言葉は不自然だよ。",
        "ケイト、消しゴムを使ってもいい？","いいよ。はい、どうぞ。"),
      mkQ("You have a fever. ( )","👩","OK, I will.","👦",
        ["Please rest at home.","It's sunny today.","Nice to meet you.","See you tomorrow."],
        0,
        "熱があるとき、看護師さんは何と言う？「Please rest at home.（家で休んでね）」が正解！",
        "熱がありますね。家で休んでください。","わかりました。"),
      mkQ("Is this your umbrella, Grace?","👦","( ) Mine is red.","👧",
        ["No, it isn't.","Yes, it is.","You're welcome.","That's OK."],
        0,
        "グレースのかさは赤いのに、聞かれたかさはちがう色みたいだね。「No, it isn't.（いいえ、ちがいます）」が正解！「Mine is red.」とつながるね。",
        "グレース、これはあなたのかさ？","いいえ、ちがうよ。わたしのは赤いの。"),
      mkQ("Great job today, everyone! ( )","👨","Thanks, Coach Wilson.","👦",
        ["Practice is over.","It's raining.","I'm tired.","We're hungry."],
        0,
        "「今日はよくがんばったね！」のあとに、コーチが自然に言いそうなことは？「Practice is over.（れんしゅうはおわりです）」が正解！",
        "今日はみんなよくがんばりました！れんしゅうはおわりです。","ありがとうございます、ウィルソンコーチ。"),
      mkQ("I lost my pencil case, Mrs. Green.","👧","( ) Let's look for it together.","👩",
        ["That's too bad.","You're welcome.","Good idea.","See you."],
        0,
        "こまっている話を聞いたときは「That's too bad.（それはざんねんだね）」と言うよ。\n「Good idea.」→ ていあんに賛成するときの言葉だから、ここでは合わないよ。",
        "先生、筆箱をなくしちゃったの。","それはざんねんね。いっしょにさがしましょう。"),
    ],
    quiz: [
      mkQ("I like your new shoes, Lucy.","👦","( )","👧",
        ["Thanks, Tom.","You're welcome, Tom.","See you, Tom.","Excuse me, Tom."],
        0, null,
        "ルーシー、新しいくつすてきだね。","ありがとう、トム。"),
      mkQ("Please take out your homework. ( )","👩","OK, Ms. Johnson.","👦",
        ["I'll check it now.","You can go home.","It's raining.","Good morning."],
        0, null,
        "宿題を出してください。今からチェックします。","わかりました、ジョンソン先生。"),
      mkQ("Do you want some tea, Ben?","👩","( )","👦",
        ["Yes, please.","You're welcome.","That's OK.","See you."],
        0, null,
        "ベン、お茶はいかが？","はい、お願いします。"),
      mkQ("Turn to page twenty. ( )","👨","OK, Mr. White.","👧",
        ["Let's read together.","You can go home.","It's cold today.","See you tomorrow."],
        0, null,
        "20ページを開いてください。いっしょに読みましょう。","わかりました、ホワイト先生。"),
      mkQ("Thank you for helping me, Kevin.","👧","( )","👦",
        ["You're welcome.","Thank you.","I'm sorry.","Good idea."],
        0, null,
        "手伝ってくれてありがとう、ケビン。","どういたしまして。"),
      mkQ("Let's clean the classroom now. ( )","👩","OK, let's start.","👦",
        ["Please get your brooms.","You can go home.","It's a holiday.","See you tomorrow."],
        0, null,
        "教室をそうじしましょう。ほうきを持ってきてください。","わかりました、始めましょう。"),
      mkQ("I can't come to your birthday party, Mia.","👦","( )","👧",
        ["That's too bad.","Good idea.","You're welcome.","Congratulations."],
        0,
        "むずかしい！\n「Good idea.」→ ていあんに賛成するときの言葉だから、ここでは合わないよ。\n「Congratulations.」→ おめでとうと言うときの言葉だよ。パーティーに行けないという残念な話には合わないね。\n「That's too bad.」→ 「それはざんねん」という意味で、悲しい知らせに対する自然な返事だから正解！",
        "ミア、たんじょう日パーティーに行けないんだ。","それはざんねんね。"),
    ],
  },
};
