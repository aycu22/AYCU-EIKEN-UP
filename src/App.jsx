...
const DIALOGUE_TOPICS = [
  ...
  { id:"out_about",   title:"OUT & ABOUT", emoji:"🚉", color:"#f59e0b", shadow:"#b45309", level:"5", speakerLabels: FRIENDS_LABELS },
...
const DIALOGUE_TESTS = {
  ...
  out_about: {
    practice1: [
      mkQ("Excuse me. What time does the next bus come?","👩","( )","👦",
        ["It's Tuesday.","At three thirty.","By bus.","For one hour."],
        1,
        "「What time」→ じかんで答えよう！\n「At three thirty.」→ じかんを答えているから正解！\n「By bus.」→ これは「どうやって？」への答えだよ。\n「For one hour.」→ これは「どのくらい？」への答えだよ。",
        "すみません。次のバスは何時に来ますか。","3時30分です。"),
      mkQ("Excuse me. How much is this notebook?","👧","( )","👩",
        ["It's blue.","It's very nice.","It's 200 yen.","It's on the shelf."],
        2,
        "「How much」→ ねだんで答えよう！\n「It's 200 yen.」→ ねだんを答えているから正解！\n「It's blue.」→ これは「何色？」への答えだよ。\n「It's on the shelf.」→ これは「どこ？」への答えだよ。",
        "すみません。このノートはいくらですか。","200円です。"),
      mkQ("Where's Mom, Dad?","👦","( )","👨",
        ["She's tall.","She likes shopping.","She's at the mall.","She comes home at six."],
        2,
        "「Where's Mom?」→ ばしょで答えよう！\n「She's at the mall.」→ ばしょを答えているから正解！\n「She likes shopping.」→ これは「すきなこと」を言っているよ。\n「She comes home at six.」→ これは「いつ？」への答えだよ。",
        "お母さんはどこ、お父さん？","モールにいるよ。"),
      mkQ("Hi Ken! What are you doing here?","👩","( )","👦",
        ["I like this store.","I come here every week.","I'm buying some milk.","I bought milk yesterday."],
        2,
        "「What are you doing?」→「I'm ＋ 〜ing」で答えよう！\n「I'm buying some milk.」→「I'm +〜ing」の形だから正解！\n「I bought milk yesterday.」→「bought」はきのうのことだよ。今じゃないね。\n「I come here every week.」→ まいしゅうのことを言っているよ。今のことじゃないね。",
        "あら、ケン！ここで何をしているの？","牛乳を買っているところだよ。"),
      mkQ("Excuse me. Where are the children's shoes?","👧","( )","👩",
        ["They're very nice.","They're on the third floor.","They're cheap.","They come in many colors."],
        1,
        "「Where are~?」→ ばしょで答えよう！\n「They're on the third floor.」→ ばしょを答えているから正解！\n「They're very nice.」→ くつの感想だよ。ばしょじゃないね。\n「They come in many colors.」→ 色のことを言っているよ。ばしょじゃないね。",
        "すみません。子ども用のくつはどこですか。","3階にあります。"),
      mkQ("Let's go to the new ice cream shop after this!","👦","( )","👧",
        ["Ice cream is cold.","I like ice cream.","That's a good idea!","The shop is new."],
        2,
        "「Let's~!」→ さそいにのる返事を選ぼう！\n「That's a good idea!」→「いいね！」という意味だから正解！\n「Ice cream is cold.」→ アイスクリームのことを言っているよ。さそいへの返事じゃないね。\n「The shop is new.」→「new（新しい）」という言葉をくり返しているよ。だまされないで！",
        "このあと、新しいアイスクリーム屋さんに行こう！","それはいいね！"),
      mkQ("That's a really nice bike!","👦","( ) I got it for my birthday.","👧",
        ["Bikes are fast.","I like bikes.","Thanks!","It's very fast."],
        2,
        "じてんしゃをほめられたよ。なんて答える？\n「Thanks!」→ ほめられたときは「ありがとう！」が正解！\n「Bikes are fast.」と「It's very fast.」→「速い」という言葉を使っているよ。だまされないで！",
        "それ、本当にすてきな自転車だね！","ありがとう！"),
    ],
    practice2: [
      mkQ("Excuse me. What time does the last train to Osaka leave?","👩","( ) You still have 20 minutes.","👦",
        ["For about two hours.","At ten fifteen.","From platform three.","It's very fast."],
        1,
        "「You still have 20 minutes.（まだ20分あるよ）」→ 電車はもうすぐ出るんだね。じかんで答えよう！\n「At ten fifteen.」→ じかんを答えているから正解！「まだ20分ある」からまにあうんだね。\n「From platform three.」→ これは「どこから？」への答えだよ。",
        "すみません。大阪行きの最終電車は何時に出ますか。","10時15分です。"),
      mkQ("Excuse me. How much are these gloves?","👦","( ) They're on sale today!","👩",
        ["They're very warm.","They're in black and brown.","They're 1,500 yen.","They're on the second floor."],
        2,
        "「They're on sale today!（今日はセールだよ！）」→ セールのまえにねだんを言うんだね！\n「They're 1,500 yen.」→ ねだんを答えているから正解！\n「They're in black and brown.」→ 色のことを言っているよ。ねだんじゃないね。\n「They're on the second floor.」→ ばしょを言っているよ。ねだんじゃないね。",
        "すみません。この手袋はいくらですか。","1,500円です。"),
      mkQ("Dad, where's Mom? She's not answering her phone.","👧","( ) She probably can't hear it in there.","👨",
        ["She's very busy.","She's at the supermarket.","She likes shopping.","She'll be home soon."],
        1,
        "「She probably can't hear it in there.（たぶん中でおとが聞こえないんだよ）」→ お母さんはお店の「中」にいるんだね！どこ？\n「She's at the supermarket.」→ ばしょを答えているから正解！スーパーの中にいるから電話が聞こえないんだね。\n「She'll be home soon.」→ これは「いつ？」への答えだよ。",
        "お父さん、お母さんはどこ？電話に出ないの。","スーパーにいるよ。"),
      mkQ("Hi Lisa! I didn't expect to see you here. What are you doing?","👩","( ) My sister's birthday is next week.","👧",
        ["I come here every Saturday.","I bought a present yesterday.","I'm looking for a birthday present.","I like this store."],
        2,
        "「My sister's birthday is next week.（来週、妹のたんじょう日だよ）」→ たんじょう日のまえにお店で何をする？「I'm ＋ 〜ing」で答えよう！\n「I'm looking for a birthday present.」→「I'm +〜ing」の形で、たんじょう日プレゼントをさがしているから正解！\n「I bought a present yesterday.」→「bought」はきのうのことだよ。でもまださがしているんだね。",
        "あら、リサ！ここで会うとは思わなかったよ。何をしているの？","たんじょう日プレゼントをさがしているの。"),
      mkQ("Excuse me. I'm looking for the men's jackets. Where are they?","👦","( ) I can take you there if you like.","👩",
        ["They're very warm.","They're on the fourth floor.","They come in many sizes.","They're on sale."],
        1,
        "「I can take you there.（そこまで案内しますよ）」→「there（そこ）」はどこのこと？ばしょで答えよう！\n「They're on the fourth floor.」→ ばしょを答えているから正解！「そこ」＝4階だね。\n「They're very warm.」→ ジャケットの感想だよ。ばしょじゃないね。",
        "すみません。男性用のジャケットをさがしています。どこにありますか。","4階にあります。"),
      mkQ("We finished shopping early! Let's get some lunch before we go home.","👧","( ) I'm hungry too!","👩",
        ["We finished shopping.","Let's go home.","That sounds great!","Lunch is expensive."],
        2,
        "「I'm hungry too!（わたしもおなかすいた！）」→ お母さんも賛成しているね。どの返事が「いいね！」の意味？\n「That sounds great!」→「それはいいね！」という意味だから正解！\n「Let's go home.」→「Let's〜」のさそいに「家に帰ろう」は合っていないね。",
        "早く買い物が終わったね！家に帰るまえにお昼を食べよう。","それはいいね！"),
      mkQ("Excuse me. That's a beautiful bag!","👩","( ) I bought it last weekend.","👧",
        ["Bags are useful.","It's very big.","Thanks!","I like bags."],
        2,
        "かばんをほめられたよ。「I bought it last weekend.（先週買ったんです）」の前に何を言う？\n「Thanks!」→ ほめられたときは「ありがとう！」が自然な返事だから正解！\n「Bags are useful.」→ かばんのことを言っているけど、ほめられたへの返事じゃないよ。",
        "すみません。それ、すてきなかばんですね！","ありがとう！"),
    ],
    practice3: [
      mkQ("Excuse me. What time does the next train come?","👩","( ) You have about five minutes.","👦",
        ["For thirty minutes.","From platform two.","At four fifteen.","It's very fast."],
        2,
        "「You have about five minutes.（あと5分くらいあるよ）」→ 電車はもうすぐ来るんだね。じかんで答えよう！\n「At four fifteen.」→ じかんを答えているから正解！\n「For thirty minutes.」→ これは「どのくらい？」への答えだよ。「What time」とちがうよ。\n「From platform two.」→ これは「どこから？」への答えだよ。",
        "すみません。次の電車は何時に来ますか。","4時15分です。"),
      mkQ("Excuse me. How much is this hat?","👦","( )","👩",
        ["It's blue and white.","It's very popular.","It's 800 yen.","It's on the shelf."],
        2,
        "「How much」→ ねだんで答えよう！ぜんぶ「It's」で始まっているよ。だまされないで！\n「It's 800 yen.」→ ねだんを答えているから正解！\n「It's blue and white.」→ 色を答えているよ。「It's」があってもまちがいになるよ！\n「It's on the shelf.」→ ばしょを答えているよ。「It's」があってもまちがいになるよ！",
        "すみません。この帽子はいくらですか。","800円です。"),
      mkQ("Dad, where's Mom? I can't find her.","👧","( ) She'll be back soon.","👨",
        ["She's buying some vegetables.","She likes vegetables.","She cooks every day.","She's very busy."],
        0,
        "「She'll be back soon.（もうすぐ帰ってくるよ）」→ 今は外に出ているんだね。今どこで何をしている？\n「She's buying some vegetables.」→ 今いるばしょとしていることを答えているから正解！\n「She likes vegetables.」→ すきなものを言っているよ。今どこにいるかじゃないね。\n「She cooks every day.」→ まいにちのことを言っているよ。今のことじゃないね。",
        "お父さん、お母さんはどこ？見つからないの。","野菜を買っているよ。"),
      mkQ("Oh, hi Mark! What are you doing here?","👩","( ) My mom asked me to get some bread.","👦",
        ["I come here every week.","I bought some bread.","I'm shopping for groceries.","This store is nice."],
        2,
        "「My mom asked me to get some bread.（お母さんにパンを買ってきてと言われたよ）」→ まだ買っていないね。「I'm ＋ 〜ing」で答えよう！\n「I'm shopping for groceries.」→「I'm +〜ing」の形で、今かいものしているから正解！\n「I bought some bread.」→「bought」はもう買ったことだよ。でも「get some bread」からまだ買っていないね！",
        "あ、マーク！ここで何をしているの？","食料品を買っているところだよ。"),
      mkQ("Excuse me. Where are the notebooks?","👧","( ) They're right next to the pens.","👩",
        ["They're very useful.","They come in many colors.","They're on the second floor.","They're not expensive."],
        2,
        "「They're right next to the pens.（ペンのすぐとなりにあるよ）」→ さらにくわしいばしょを教えてくれているね。答えもばしょのはず！\n「They're on the second floor.」→ ばしょを答えているから正解！2階のペンのとなりにあるんだね。\n「They're very useful.」と「They're not expensive.」→ ノートのことを言っているけど、ばしょじゃないよ。",
        "すみません。ノートはどこにありますか。","2階にあります。"),
      mkQ("We still have time before the bus comes. ( )","👩","Yes, let's! I'm thirsty.","👧",
        ["The bus is late.","Let's get some juice!","I like juice.","The bus comes soon."],
        1,
        "「Yes, let's! I'm thirsty.（うん、そうしよう！のどがかわいた）」→ のどがかわいているから、「のみもの」のさそいに賛成したんだね！\n「Let's get some juice!」→ のみもののさそいで、「Let's」に「Yes, let's!」が合っているから正解！\n「The bus is late.」と「The bus comes soon.」→「bus（バス）」という言葉をくり返しているよ。だまされないで！",
        "バスが来るまでまだ時間があるね。ジュースを買おう！","うん、そうしよう！のどがかわいた。"),
      mkQ("That's a really nice bike!","👦","( ) I got it for my birthday.","👧",
        ["Bikes are fast.","I like bikes.","Thanks!","It's very fast."],
        2,
        "じてんしゃをほめられたよ。「I got it for my birthday.（たんじょう日にもらったんだ）」の前に何を言う？\n「Thanks!」→ ほめられたときは「ありがとう！」が自然な返事だから正解！\n「Bikes are fast.」と「It's very fast.」→ どちらも「速い」という意味だよ。ほめられたへの返事じゃないね。",
        "それ、本当にすてきな自転車だね！","ありがとう！"),
    ],
    quiz: [
      mkQ("Excuse me. What time does the library open?","👩","( )","👦",
        ["It's Monday.","It's very big.","At nine o'clock.","By bus."],
        2,
        "「What time?（何時？）」→ じかんで答えよう！\n「At nine o'clock.」が正解！\n「It's Monday.」は「何曜日？」への答えだよ。",
        "すみません。図書館は何時に開きますか。","9時です。"),
      mkQ("Excuse me. How much is this cap?","👧","( )","👩",
        ["It's on the shelf.","It's red and white.","It's very cute.","It's 500 yen."],
        3,
        "「How much?（いくら？）」→ ねだんで答えよう！\n「It's 500 yen.」が正解！\nぜんぶ「It's」で始まっているよ。だまされないで！",
        "すみません。この帽子はいくらですか。","500円です。"),
      mkQ("Dad, where's Mom?","👦","( ) She'll be home for dinner.","👨",
        ["She's very kind.","She's at the supermarket.","She likes cooking.","She cooks every night."],
        1,
        "「Where?（どこ？）」→ ばしょで答えよう！\n「She's at the supermarket.」が正解！\n「She'll be home for dinner.」からまだ外にいることがわかるね。",
        "お父さん、お母さんはどこ？","スーパーにいるよ。"),
      mkQ("Sara! What are you doing here?","👩","( ) My brother's birthday is tomorrow!","👧",
        ["I like this store.","I come here every week.","I'm looking for a present.","I bought a present."],
        2,
        "「What are you doing?」→「I'm +〜ing」で答えよう！\n「I'm looking for a present.」が正解！\n「My brother's birthday is tomorrow!」からプレゼントをさがしているんだね。",
        "サラ！ここで何をしているの？","プレゼントをさがしているの。"),
      mkQ("Excuse me. Where are the women's boots?","👦","( )","👩",
        ["They're very popular.","They're on the first floor.","They come in many sizes.","They're on sale today."],
        1,
        "「Where?（どこ？）」→ ばしょで答えよう！\n「They're on the first floor.」が正解！\n「They're on sale today.」はセールのことだよ。ばしょじゃないね。",
        "すみません。女性用のブーツはどこですか。","1階にあります。"),
      mkQ("Let's take a photo here before we go!","👧","( ) It's a beautiful view!","👩",
        ["I have a camera.","Photos are nice.","That's a great idea!","Let's go home."],
        2,
        "「Let's~!」→ さそいに「いいね！」と答えよう！\n「That's a great idea!」が正解！\n「It's a beautiful view!（きれいな景色！）」から賛成しているのがわかるね。",
        "行くまえに、ここで写真をとろう！","それはいいね！"),
      mkQ("What a cute dog! Is it yours?","👩","( ) His name is Pochi.","👦",
        ["I like dogs.","Dogs are cute.","Yes, he's mine!","It's very cute."],
        2,
...
const VOCAB_CATEGORIES_PRE2 = [
  ...
  {
    id: "p2_a2", title: "A2 · Feelings & States", emoji: "🎭", isPre2: true,
    color: "#0891b2", shadow: "#155e75",
    words: [
      { en:"nervous",    kanji:"緊張した",       kana:"きんちょうした",   hint:"I felt so _____ before giving my speech in front of the whole class.",
        definition:"anxious or worried, especially before an event",
        sentenceJp:"クラス全員の前でスピーチをする前、とても緊張しました。" },
      { en:"exhausted",  kanji:"ぐったり疲れた", kana:"ぐったりつかれた", hint:"After the long hike up the mountain, we were completely _____.",
        definition:"extremely tired",
        sentenceJp:"山を長く登った後、私たちは完全にぐったり疲れていました。" },
      { en:"serious",    kanji:"真剣な",         kana:"しんけんな",       hint:"She is _____ about becoming a doctor, so she studies every night.",
        definition:"earnest and not joking; deeply committed",
        sentenceJp:"彼女は医者になることに真剣なので、毎晩勉強しています。" },
      { en:"ready",      kanji:"準備ができて",   kana:"じゅんびができて", hint:"Are you _____ to leave? The bus comes in five minutes.",
        definition:"prepared to do something",
        sentenceJp:"出発の準備はできましたか。バスは5分後に来ます。" },
      { en:"certain",    kanji:"確かな",         kana:"たしかな",         hint:"I'm _____ that I locked the door before we left.",
        definition:"sure about a fact",
        sentenceJp:"出かける前にドアに鍵をかけたのは確かです。" },
      { en:"secret",     kanji:"秘密の",         kana:"ひみつの",         hint:"They are planning a _____ party for their mother's birthday.",
        definition:"kept hidden from other people",
        sentenceJp:"彼らは母の誕生日のために秘密のパーティーを計画しています。" },
      { en:"personal",   kanji:"個人の",         kana:"こじんの",         hint:"Please don't read my diary — it's _____.",
        definition:"private to one individual",
        sentenceJp:"私の日記を読まないでください。個人的なものです。" },
      { en:"formal",     kanji:"正式の",         kana:"せいしきの",       hint:"We had to wear _____ clothes to the wedding.",
        definition:"official or in a proper, respectful style",
        sentenceJp:"結婚式には正式な服装をしなければなりませんでした。" },
      { en:"negative",   kanji:"否定的",         kana:"ひていてき",       hint:"He has such a _____ attitude that he thinks nothing will work.",
        definition:"not positive; pessimistic",
        sentenceJp:"彼はとても否定的な態度で、何もうまくいかないと思っています。" },
      { en:"refreshing", kanji:"さわやかな",     kana:"さわやかな",       hint:"After the hot afternoon, the cold lemonade was really _____.",
        definition:"pleasantly cool or reviving",
        sentenceJp:"暑い午後の後、冷たいレモネードは本当にさわやかでした。" },
    ],
  },
  {
  ...
  {
    id: "p2_v2", title: "V2 · Cause, Harm & Protect", emoji: "🛡️", isPre2: true,
    color: "#7c3aed", shadow: "#5b21b6",
    words: [
      { en:"cause",    kanji:"引き起こす", kana:"ひきおこす",
        hint:"Eating too much sugar can _____ health problems.",
        definition:"to make a bad result happen",
        sentenceJp:"砂糖を取りすぎると健康問題を引き起こすことがあります。" },
      { en:"prevent",  kanji:"防ぐ",       kana:"ふせぐ",
        hint:"Washing your hands often can _____ colds.",
        definition:"to stop something before it happens",
        sentenceJp:"よく手を洗うことで風邪を防ぐことができます。" },
      { en:"damage",   kanji:"損傷させる", kana:"そんしょうさせる",
        hint:"Heavy rain can _____ a roof, but the house can still be lived in.",
        definition:"to partly harm something so it is hurt but still exists",
        sentenceJp:"大雨で屋根が傷つきましたが、まだその家に住めました。" },
      { en:"destroy",  kanji:"破壊する",   kana:"はかいする",
        hint:"A big fire can completely _____ an old building.",
        definition:"to ruin something completely so nothing is left",
        sentenceJp:"大きな火事がその古い建物を完全に破壊しました。" },
      { en:"harm",     kanji:"害を与える", kana:"がいをあたえる",
        hint:"Too much sunlight can _____ your skin.",
        definition:"to have a bad effect on health or wellbeing, no wound needed",
        sentenceJp:"日光を浴びすぎると肌に害を与えることがあります。" },
      { en:"injure",   kanji:"負傷させる", kana:"ふしょうさせる",
        hint:"Playing sports carelessly can _____ your leg.",
        definition:"to cause physical bodily injury, often by accident or in sport",
        sentenceJp:"彼はサッカーをしていて足をけがしました。" },
      { en:"protect",  kanji:"守る",       kana:"まもる",
        hint:"Wearing a helmet can _____ your head when you ride a bike.",
        definition:"to keep someone or something safe from harm or danger",
        sentenceJp:"自転車に乗るとき、ヘルメットは頭を守ります。" },
      { en:"defend",   kanji:"防衛する",   kana:"ぼうえいする",
        hint:"The players worked hard to _____ their goal in the second half.",
        definition:"to protect against an attacker or opponent",
        sentenceJp:"選手たちは後半、ゴールを守るために懸命に戦いました。" },
      { en:"produce",  kanji:"生産する",   kana:"せいさんする",
        hint:"This factory can _____ thousands of cars every year.",
        definition:"to manufacture goods in quantity",
        sentenceJp:"この工場は毎年何千台もの車を生産します。" },
      { en:"create",   kanji:"創り出す",   kana:"つくりだす",
        hint:"An artist can _____ a beautiful painting for a museum.",
        definition:"to make something new or original",
        sentenceJp:"その画家は美術館のために美しい絵を創り出しました。" },
    ],
  },
];
...
function DialoguePracticeScreen({ topic, setKey, onBack, onComplete }) {
  ...
  if (phase === "done" && isQuiz) {
    return <DialogueQuizResults score={score} total={questions.length} answers={quizAnswers} onBack={onBack} topicTitle={topic.title} onRetry={() => { setQIdx(0); setPhase("question"); setSelected(null); setScore(0); setQuizAnswers([]); }} />;
  }
  if (phase === "done") {
    return (
...
/* Quiz results screen */
function DialogueQuizResults({ score, total, answers, onBack, onRetry, topicTitle }) {
  const pct = Math.round((score / total) * 100);
  const msg = score === total ? { txt:`かんぺき！すごい！${topicTitle ? topicTitle + " " : ""}マスター！`, emoji:"🏆" }
